...
import {
  FacultyManager,
  type Faculty,
} from "./components/FacultyManager";
import {
  ClassroomManager,
  type Classroom,
} from "./components/ClassroomManager";
import {
  ScheduleGenerator,
  type ScheduleItem,
} from "./components/ScheduleGenerator";
...
export default function App() {
  const [courses, setCourses] =
    useState<Course[]>(SAMPLE_COURSES);
  const [faculty, setFaculty] =
    useState<Faculty[]>(SAMPLE_FACULTY);
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Optimize your academic schedule with intelligent
            ...
            <CardContent className="flex items-center justify-between p-6">
              <div>
                ...
                <div className="text-sm text-muted-foreground mt-1">
                  FY:{" "}
                  {
                    courses.filter((c) => c.year === "FY")
                      .length
                  }{" "}
                  | SY:{" "}
                  {
                    courses.filter((c) => c.year === "SY")
                      .length
                  }{" "}
                  | TY:{" "}
                  {
                    courses.filter((c) => c.year === "TY")
                      .length
                  }
                </div>
              </div>
            ...
            <CardContent className="flex items-center justify-between p-6">
              <div>
                ...
                <div className="text-sm text-muted-foreground mt-1">
                  FY:{" "}
                  {
                    schedule.filter((s) => s.year === "FY")
                      .length
                  }{" "}
                  | SY:{" "}
                  {
                    schedule.filter((s) => s.year === "SY")
                      .length
                  }{" "}
                  | TY:{" "}
                  {
                    schedule.filter((s) => s.year === "TY")
                      .length
                  }
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  including faculty availability, room capacity,
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Automatically detect and report scheduling
                  conflicts with detailed analysis and
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Optimize classroom usage and ensure required
                  resources are available for each scheduled
                  class.
                </p>
              </div>
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Manage course prerequisites and ensure logical
                  course sequencing for student academic
                  progression.
                </p>
              </div>
            </div>
